...
def render_signin_page():
    ...
    st.markdown(f"""
    <button class="google-btn" onclick="window.top.location.href='{supabase_url}/auth/v1/authorize?provider=google&redirect_to=' + encodeURIComponent(window.location.href)">
